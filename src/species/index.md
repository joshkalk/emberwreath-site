...
<div class="card-grid species-grid">
  <section class="card species-card">
    ...
    <p><a href="{{ '/species/humans/' | url }}">Read next: Humans</a></p>
  </section>
  ...
  <section class="card species-card">
    ...
    <p><a href="{{ '/species/zivari/' | url }}">Read next: Zivari</a></p>
  </section>
  ...
  <section class="card species-card">
    ...
    <p><a href="{{ '/species/veyr/' | url }}">Read next: Veyr</a></p>
  </section>
  ...
  <section class="card species-card">
    ...
    <p><a href="{{ '/species/ferren/' | url }}">Read next: Ferren</a></p>
  </section>
  ...
  <section class="card species-card">
    ...
    <p><a href="{{ '/species/aumari/' | url }}">Read next: Aumari</a></p>
  </section>
  ...
  <section class="card species-card">
    ...
    <p><a href="{{ '/species/axali/' | url }}">Read next: Axali</a></p>
  </section>
  ...
  <section class="card species-card">
    ...
    <p><a href="{{ '/species/scolen/' | url }}">Read next: Scolen</a></p>
  </section>
  ...
  <section class="card species-card">
    ...
    <p><a href="{{ '/species/kelden/' | url }}">Read next: Kelden</a></p>
  </section>
  ...
  <section class="card species-card">
    ...
    <p><a href="{{ '/species/thryss/' | url }}">Read next: Thryss</a></p>
  </section>
</div>
