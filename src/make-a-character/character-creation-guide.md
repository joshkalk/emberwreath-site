...
Use this page when you are new to Emberwreath and want to make a character without reading the whole site first. It is a practical orientation guide, not a dense lore article or a full mechanical character builder.

<div class="callout">
<strong>Quick start:</strong> read the setting pitch, skim the species options, choose one place that shaped your character, then bring a few open questions to Session Zero.
</div>

## Welcome to Emberwreath

Emberwreath is a volcanic archipelago setting for Dungeons & Dragons. Characters are shaped by islands, sea routes, trade needs, old homelands, sacred places, family memory, and newer settlements that formed after contact between peoples.

You do not need to know every island or every old warning before play. A strong character usually needs only three anchors:
...
Follow this order if you are starting from nothing:
...
3. **Species:** Use the [Species Comparison]({{ '/species/comparison/' | url }}) first, then open [Playable Species]({{ '/species/' | url }}) only for the species that interest you.
...
Species and homeland are related, but they are not identical. Your character might be from an ancestral homeland, a trade hub, a newer mixed settlement, a sea route, a work site, a pilgrimage path, or an island where their species is less common.

Ask two questions:

1. **Where did people expect your character to belong?** This might be their species homeland, family tradition, workplace, route, or household.
2. **Where did your character actually become themselves?** This might be the same place, or it might be an adopted island, port, convoy, disaster site, shrine route, or mixed community.

If you are unsure, pick the species that excites you first, then use [Where Are You From?]({{ '/make-a-character/where-are-you-from/' | url }}) to choose a specific homeland or starting place.

## Questions to bring to Session Zero

Bring short answers or strong maybes. You do not need final canon decisions before talking with the group.

- Which species interests you most, and why?
- What island, route, settlement, or environment shaped your character?
- What taboo, duty, trade, voyage, disaster, or sacred place matters to them?
- Are they rooted in one place, or shaped by movement between islands?
- What do they believe about old warnings and forbidden places?
- What practical role could they fill for a traveling party?
